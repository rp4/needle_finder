        ...
        <div
          className={`w-full max-w-2xl p-12 border-2 border-dashed rounded-xl transition-all ${
            isDragging
              ...
              : 'border-gray-600 bg-gray-800/50 hover:border-indigo-500/50'
          }`}
          onDrop={handleDrop}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl overflow-hidden">
          <div className="p-4 border-b border-gray-700">
            <h3 className="text-lg font-semibold text-gray-200">Anomalies</h3>
          </div>
                ...
                {sortedAnomalies.slice(0, 10).map((anomaly) => (
                  <tr
                    ...
                    className={`hover:bg-gray-800/50 transition-colors cursor-pointer ${
                      selectedAnomaly?.id === anomaly.id ? 'bg-gray-800/70' : ''
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
          ...
          {selectedAnomaly ? (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gray-900/50 p-3 rounded-lg">
                  ...
                  <p className="text-sm font-medium text-gray-200 truncate" title={selectedAnomaly.id}>
                    {selectedAnomaly.id}
                  </p>
                </div>
                <div className="bg-gray-900/50 p-3 rounded-lg">
              ...
              <div className="bg-gray-900/50 p-3 rounded-lg">
                <p className="text-xs text-gray-400 mb-2">Severity & Score</p>
            ...
            <div className="h-64 flex items-center justify-center text-gray-500">
              <div className="text-center">
                <p className="mb-2">Select an anomaly from the table to view details</p>
                <p className="text-sm text-gray-600">Click on any row to see more information</p>
              </div>
            </div>
          )}
        </div>
